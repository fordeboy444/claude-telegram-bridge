...
- **URL:** https://core.telegram.org/bots/api/[](https://core.telegram.org/bots/api#updating-messages)\/[](https://core.telegram.org/bots/api#stopmessagelivelocation)\
- **Summary:** stopMessageLiveLocation\ Use this method to stop updating a live location message before _live_period_ expires.

# \

stopMessageLiveLocation\
\
Use this method to stop updating a live location message before _live_period_ expires. On success, if the message is not an inline message, the edited [Message](https://core.telegram.org/bots/api#message)\
