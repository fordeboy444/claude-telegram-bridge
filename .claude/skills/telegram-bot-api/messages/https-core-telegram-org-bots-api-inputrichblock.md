...
- **URL:** https://core.telegram.org/bots/api/[](https://core.telegram.org/bots/api#rich-messages)\/[](https://core.telegram.org/bots/api#inputrichblock)\
- **Summary:** This object represents a block in a rich formatted message to be sent.
