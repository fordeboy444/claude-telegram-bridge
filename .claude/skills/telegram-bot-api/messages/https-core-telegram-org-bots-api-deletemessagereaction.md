...
- **URL:** https://core.telegram.org/bots/api/[](https://core.telegram.org/bots/api#updating-messages)\/[](https://core.telegram.org/bots/api#deletemessagereaction)\
- **Summary:** deleteMessageReaction\ Use this method to remove a reaction from a message in a group or a supergroup chat.
