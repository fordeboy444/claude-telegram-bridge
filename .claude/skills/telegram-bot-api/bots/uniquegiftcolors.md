...
- **URL:** https://core.telegram.org/bots/api/available-types/uniquegiftcolors
- **Summary:** This object contains information about the color scheme for a user's name, message replies and link previews based on a unique gift.
