...
- **URL:** https://core.telegram.org/bots/api/available-methods/[](https://core.telegram.org/bots/api#repoststory)\
- **Summary:** Reposts a story on behalf of a business account from another business account.
