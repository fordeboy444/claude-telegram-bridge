...
- **URL:** https://core.telegram.org/bots/api/[](https://core.telegram.org/bots/api#inline-mode)\/[](https://core.telegram.org/bots/api#answerinlinequery)\
- **Summary:** Use this method to send answers to an inline query.
