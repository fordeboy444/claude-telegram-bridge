...
- **URL:** https://core.telegram.org/bots/api/available-methods/[](https://core.telegram.org/bots/api#unbanchatmember)\
- **Summary:** Use this method to unban a previously banned user in a supergroup or channel.
