...
- **URL:** https://core.telegram.org/bots/api/available-types/inputstorycontentphoto
- **Summary:** InputStoryContentPhoto Describes a photo to post as a story. | type | String | Type of the content, must be _photo_ | | photo | String | The photo to post as a story.
