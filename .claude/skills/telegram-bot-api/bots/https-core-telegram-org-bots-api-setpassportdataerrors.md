...
- **URL:** https://core.telegram.org/bots/api/[](https://core.telegram.org/bots/api#telegram-passport)\/[](https://core.telegram.org/bots/api#setpassportdataerrors)\
- **Summary:** setPassportDataErrors\ Informs a user that some of the Telegram Passport elements they provided contains errors.
