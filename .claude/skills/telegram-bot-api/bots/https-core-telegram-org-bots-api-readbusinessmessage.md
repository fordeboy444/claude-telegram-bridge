...
- **URL:** https://core.telegram.org/bots/api/available-methods/[](https://core.telegram.org/bots/api#readbusinessmessage)\
- **Summary:** readBusinessMessage\ Marks incoming message as read on behalf of a business account.
