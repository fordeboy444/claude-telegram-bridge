...
- **URL:** https://core.telegram.org/bots/api/available-methods/[](https://core.telegram.org/bots/api#setchattitle)\
- **Summary:** Use this method to change the title of a chat.
