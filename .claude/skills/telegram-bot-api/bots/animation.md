...
- **URL:** https://core.telegram.org/bots/api/available-types/animation
- **Summary:** This object represents an animation file (GIF or H.264/MPEG-4 AVC video without sound). | width | Integer | Video width as defined by the sender | | height | Integer | Video height as defined by the sender | | duration | Integer | Duration of the video in seconds as defined by the sender | |...
