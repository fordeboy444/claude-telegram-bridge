...
- **URL:** https://core.telegram.org/bots/api/available-methods/[](https://core.telegram.org/bots/api#getusergifts)\
- **Summary:** Returns the gifts owned and hosted by a user.

# \

getUserGifts\
\
Returns the gifts owned and hosted by a user. Returns [OwnedGifts](https://core.telegram.org/bots/api#ownedgifts)\
 on success.\
\
