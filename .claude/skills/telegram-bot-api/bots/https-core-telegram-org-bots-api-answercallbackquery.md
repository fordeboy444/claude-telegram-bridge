...
- **URL:** https://core.telegram.org/bots/api/available-methods/[](https://core.telegram.org/bots/api#answercallbackquery)\
- **Summary:** answerCallbackQuery\ Use this method to send answers to callback queries sent from inline keyboards\ .
...
. The answer will be displayed to the user as a notification at the top of the chat screen or as an alert. On success, _True_ is returned.\
\
> Alternatively, the user can be redirected to the specified Game URL. For this option to work, you must first create a game for your bot via [@BotFather](https://t.me/botfather)\
