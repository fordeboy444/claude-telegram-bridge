...
- **URL:** https://core.telegram.org/bots/api/[](https://core.telegram.org/bots/api#stickers)\/[](https://core.telegram.org/bots/api#createnewstickerset)\
- **Summary:** createNewStickerSet\ Use this method to create a new sticker set owned by a user.
