...
- **URL:** https://core.telegram.org/bots/api/available-methods/[](https://core.telegram.org/bots/api#getbusinessaccountgifts)\
- **Summary:** getBusinessAccountGifts\ Returns the gifts received and owned by a managed business account.

# \

getBusinessAccountGifts\
\
Returns the gifts received and owned by a managed business account. Requires the _can_view_gifts_and_stars_ business bot right. Returns [OwnedGifts](https://core.telegram.org/bots/api#ownedgifts)\
 on success.\
\
