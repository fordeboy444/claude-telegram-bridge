...
- **URL:** https://core.telegram.org/bots/api/available-methods/[](https://core.telegram.org/bots/api#sendcontact)\
- **Summary:** Use this method to send phone contacts.

# \

sendContact\
\
Use this method to send phone contacts. On success, the sent [Message](https://core.telegram.org/bots/api#message)\
 is returned.\
\
...
| vcard | String | Optional | Additional data about the contact in the form of a [vCard](https://en.wikipedia.org/wiki/VCard)<br>, 0-2048 bytes |\
