...
- **URL:** https://core.telegram.org/bots/api/available-types/chatphoto
- **Summary:** This object represents a chat photo. | small_file_id | String | File identifier of small (160x160) chat photo.
