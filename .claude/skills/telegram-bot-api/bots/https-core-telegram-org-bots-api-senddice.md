...
- **URL:** https://core.telegram.org/bots/api/available-methods/[](https://core.telegram.org/bots/api#senddice)\
- **Summary:** Use this method to send an animated emoji that will display a random value.

# \

sendDice\
\
Use this method to send an animated emoji that will display a random value. On success, the sent [Message](https://core.telegram.org/bots/api#message)\
 is returned.\
\
