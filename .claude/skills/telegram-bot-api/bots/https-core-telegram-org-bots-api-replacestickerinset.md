...
- **URL:** https://core.telegram.org/bots/api/[](https://core.telegram.org/bots/api#stickers)\/[](https://core.telegram.org/bots/api#replacestickerinset)\
- **Summary:** replaceStickerInSet\ Use this method to replace an existing sticker in a sticker set with a new one.

# \

replaceStickerInSet\
\
Use this method to replace an existing sticker in a sticker set with a new one. The method is equivalent to calling [deleteStickerFromSet](https://core.telegram.org/bots/api#deletestickerfromset)\
