...
- **URL:** https://core.telegram.org/bots/api/available-methods/[](https://core.telegram.org/bots/api#setchatdescription)\
- **Summary:** Use this method to change the description of a group, a supergroup or a channel.
