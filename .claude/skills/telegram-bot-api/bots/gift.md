...
- **URL:** https://core.telegram.org/bots/api/available-types/gift
- **Summary:** This object represents a gift that can be sent by the bot. | id  | String | Unique identifier of the gift | | sticker | Sticker | The sticker that represents the gift | | star_count | Integer | The number of Telegram Stars that must be paid to send the sticker | | upgrade_star_count | Integer |...
