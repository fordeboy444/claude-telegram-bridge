...
- **URL:** https://core.telegram.org/bots/api/available-methods/[](https://core.telegram.org/bots/api#savepreparedinlinemessage)\
- **Summary:** savePreparedInlineMessage\ Stores a message that can be sent by a user of a Mini App.

# \

savePreparedInlineMessage\
\
Stores a message that can be sent by a user of a Mini App. Returns a [PreparedInlineMessage](https://core.telegram.org/bots/api#preparedinlinemessage)\
 object.\
\
