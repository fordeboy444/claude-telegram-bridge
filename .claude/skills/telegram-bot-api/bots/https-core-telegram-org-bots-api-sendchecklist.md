...
- **URL:** https://core.telegram.org/bots/api/available-methods/[](https://core.telegram.org/bots/api#sendchecklist)\
- **Summary:** Use this method to send a checklist on behalf of a connected business account.

# \

sendChecklist\
\
Use this method to send a checklist on behalf of a connected business account. On success, the sent [Message](https://core.telegram.org/bots/api#message)\
 is returned.\
\
