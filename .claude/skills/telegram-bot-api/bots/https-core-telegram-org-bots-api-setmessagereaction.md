...
- **URL:** https://core.telegram.org/bots/api/available-methods/[](https://core.telegram.org/bots/api#setmessagereaction)\
- **Summary:** Use this method to change the chosen reactions on a message.
