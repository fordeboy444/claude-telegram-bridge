...
- **URL:** https://core.telegram.org/bots/api/[](https://core.telegram.org/bots/api#payments)\/[](https://core.telegram.org/bots/api#affiliateinfo)\
- **Summary:** Contains information about the affiliate that received a commission via this transaction.\ | affiliate_user | User | _Optional_.
