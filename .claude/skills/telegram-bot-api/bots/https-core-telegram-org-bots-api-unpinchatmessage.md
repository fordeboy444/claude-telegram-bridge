...
- **URL:** https://core.telegram.org/bots/api/available-methods/[](https://core.telegram.org/bots/api#unpinchatmessage)\
- **Summary:** Use this method to remove a message from the list of pinned messages in a chat.
