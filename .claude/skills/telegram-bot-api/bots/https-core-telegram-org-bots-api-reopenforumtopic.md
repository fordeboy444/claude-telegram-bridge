...
- **URL:** https://core.telegram.org/bots/api/available-methods/[](https://core.telegram.org/bots/api#reopenforumtopic)\
- **Summary:** Use this method to reopen a closed topic in a forum supergroup chat.
