...
- **URL:** https://core.telegram.org/bots/api/available-methods/[](https://core.telegram.org/bots/api#giftpremiumsubscription)\
- **Summary:** giftPremiumSubscription\ Gifts a Telegram Premium subscription to the given user.
