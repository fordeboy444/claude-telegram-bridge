...
- **URL:** https://core.telegram.org/bots/api/available-types/messageentity
- **Summary:** This object represents one special entity in a text message.
...
| custom_emoji_id | String | _Optional_. For “custom_emoji” only, unique identifier of the custom emoji. Use [getCustomEmojiStickers](https://core.telegram.org/bots/api#getcustomemojistickers)<br> to get full information about the sticker. |
| unix_time | Integer | _Optional_. For “date_time” only, the Unix time associated with the entity |
| date_time_format | String | _Optional_. For “date_time” only, the string that defines the formatting of the date and time. See [date-time entity formatting](https://core.telegram.org/bots/api#date-time-entity-formatting)<br> for more details. |
