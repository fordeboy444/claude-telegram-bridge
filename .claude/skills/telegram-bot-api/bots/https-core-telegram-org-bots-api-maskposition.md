...
- **URL:** https://core.telegram.org/bots/api/[](https://core.telegram.org/bots/api#stickers)\/[](https://core.telegram.org/bots/api#maskposition)\
- **Summary:** This object describes the position on faces where a mask should be placed by default.\ | point | String | The part of the face relative to which the mask should be placed.
