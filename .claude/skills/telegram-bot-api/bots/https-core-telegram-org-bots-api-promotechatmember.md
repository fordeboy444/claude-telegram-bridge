...
- **URL:** https://core.telegram.org/bots/api/available-methods/[](https://core.telegram.org/bots/api#promotechatmember)\
- **Summary:** Use this method to promote or demote a user in a supergroup or a channel.
...
| can_send_welcome_messages | Boolean | Optional | Pass _True_ if the administrator can manage chat welcome messages or directly send them in the case of bots |\
\
