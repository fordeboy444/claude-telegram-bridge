...
- **URL:** https://core.telegram.org/bots/api/available-types/uniquegiftinfo
- **Summary:** Describes a service message about a unique gift that was sent or received. | gift | UniqueGift | Information about the gift | | origin | String | Origin of the gift.
