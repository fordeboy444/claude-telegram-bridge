...
- **URL:** https://core.telegram.org/bots/api/available-types/shareduser
- **Summary:** This object contains information about a user that was shared with the bot using a KeyboardButtonRequestUsers | user_id | Integer | Identifier of the shared user.

# shareduser

SharedUser

This object contains information about a user that was shared with the bot using a [KeyboardButtonRequestUsers](https://core.telegram.org/bots/api#keyboardbuttonrequestusers)
 button.
