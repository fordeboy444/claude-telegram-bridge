...
- **URL:** https://core.telegram.org/bots/api/available-types/inputpaidmediavideo
- **Summary:** The paid media to send is a video. | type | String | Type of the media, must be _video_ | | cover | String | _Optional_.
