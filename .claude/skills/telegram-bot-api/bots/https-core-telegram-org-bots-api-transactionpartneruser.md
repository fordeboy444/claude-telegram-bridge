...
- **URL:** https://core.telegram.org/bots/api/[](https://core.telegram.org/bots/api#payments)\/[](https://core.telegram.org/bots/api#transactionpartneruser)\
- **Summary:** TransactionPartnerUser\ Describes a transaction with a user.\ | type | String | Type of the transaction partner, always “user” |\ | transaction_type | String | Type of the transaction, currently one of “invoice_payment” for payments via invoices, “paid_media_payment” for payments for paid media,...
