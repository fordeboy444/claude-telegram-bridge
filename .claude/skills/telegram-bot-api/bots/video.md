...
- **URL:** https://core.telegram.org/bots/api/available-types/video
- **Summary:** This object represents a video file. | width | Integer | Video width as defined by the sender | | height | Integer | Video height as defined by the sender | | duration | Integer | Duration of the video in seconds as defined by the sender | | thumbnail | PhotoSize | _Optional_.
