...
- **URL:** https://core.telegram.org/bots/api/available-methods/[](https://core.telegram.org/bots/api#closeforumtopic)\
- **Summary:** Use this method to close an open topic in a forum supergroup chat.
