...
- **URL:** https://core.telegram.org/bots/api/available-types/inputprofilephotostatic
- **Summary:** InputProfilePhotoStatic A static profile photo in the .JPG format. | type | String | Type of the profile photo, must be _static_ | | photo | String | The static profile photo.
