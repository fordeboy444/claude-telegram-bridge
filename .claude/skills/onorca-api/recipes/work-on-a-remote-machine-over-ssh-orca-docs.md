# Work on a remote machine over SSH — Orca Docs

- **URL:** https://www.onorca.dev/docs/recipes/remote-worktrees
- **Summary:** Work on a remote machine over SSH — Orca documentation.

Search docs⌘K

Point Orca at any SSH target — a beefier dev box, a GPU host, a cloud sandbox — and it feels like a local worktree. Same editor, same diff view, same agents, different compute. You can open remote repos _or_ just arbitrary folders. For the full menu of local / SSH / server / ephemeral-VM modes, see [Ways to run Orca](https://www.onorca.dev/docs/ways-to-run)
.
