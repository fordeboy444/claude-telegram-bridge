# Jira items drawer — Orca Docs

- **URL:** https://www.onorca.dev/docs/review/jira
- **Summary:** Browse, edit, and link Jira Cloud or self-hosted Server/Data Center issues to worktrees the same way you link Linear or GitHub items.
...
*   [Linear items drawer](https://www.onorca.dev/docs/review/linear)
     — same flow against Linear.
*   [Hosted reviews, issues & Actions](https://www.onorca.dev/docs/review/github)
     — hand off the worktree to a hosted review once the Jira issue is in progress.
