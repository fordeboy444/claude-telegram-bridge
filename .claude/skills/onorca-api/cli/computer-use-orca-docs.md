# Computer use — Orca Docs

- **URL:** https://www.onorca.dev/docs/cli/computer-use
- **Summary:** Drive local desktop apps from an agent via accessibility trees, screenshots, and safe UI actions.
...
See [Skills registry & MCP](https://www.onorca.dev/docs/cli/skills)
 for how skills are picked up.

Next steps
----------

*   [Orca CLI overview](https://www.onorca.dev/docs/cli/overview)
     — the rest of the CLI surface (worktrees, terminal, browser).
*   [Skills registry & MCP](https://www.onorca.dev/docs/cli/skills)
     — distributing this CLI to agents.
