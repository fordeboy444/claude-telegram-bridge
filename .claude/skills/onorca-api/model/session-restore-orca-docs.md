# Session restore — Orca Docs

- **URL:** https://www.onorca.dev/docs/model/session-restore
- **Summary:** Quit Orca, reopen it, and pick up exactly where you left off — worktrees, splits, scrollback, focused tab.
...
![Restart Orca and the session — terminals, splits, scrollback, focused tab — comes back intact.](https://www.onorca.dev/whats-new/posters/session-that-survives-restart.jpg)
...
*   [Agents & sessions](https://www.onorca.dev/docs/model/agents-sessions)
     — state dots and the lifecycle of an agent session.
*   [Tabs, panes & split layouts](https://www.onorca.dev/docs/model/tabs-panes-splits)
     — how the layout you'll be restoring is built in the first place.
