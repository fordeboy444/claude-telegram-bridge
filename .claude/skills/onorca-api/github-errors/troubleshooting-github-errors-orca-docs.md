# Troubleshooting GitHub errors — Orca Docs

- **URL:** https://www.onorca.dev/docs/github-errors
- **Summary:** Diagnose rate limits, auth failures, and other GitHub CLI errors in Orca PR checks, Tasks, and Source Control.
...
| --- | --- | --- |
| “GitHub is rate-limiting requests” / “rate limit exceeded (core)” | GitHub REST (core) quota exhausted for your user | Wait for reset; stop extra `gh` / agent / Orca usage; check [Settings → Git → GitHub API Budget](https://www.onorca.dev/docs/settings) |
...
| “GitHub is unreachable” / timeouts | Network, proxy, VPN, or GitHub outage | Check [githubstatus.com](https://www.githubstatus.com/)<br>; retry off VPN |
...
Open **[Settings → Git](https://www.onorca.dev/docs/settings)
** and find **GitHub API Budget**:
