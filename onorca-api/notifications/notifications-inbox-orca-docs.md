# Notifications & Inbox — Orca Docs

- **URL:** https://www.onorca.dev/docs/notifications
- **Summary:** Notifications & Inbox — Orca documentation.
...
Turn off specific categories (system, sound, chip-only) under [Settings → Notifications](https://www.onorca.dev/docs/settings)
.

Custom sounds
-------------

Pick a custom desktop notification sound per category under [Settings → Notifications](https://www.onorca.dev/docs/settings)
 — point at any audio file on disk, or pick from Orca's built-in set. Useful when you want agent-finished pings to stand out from system mail and Slack.
