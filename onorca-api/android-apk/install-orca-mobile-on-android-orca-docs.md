# Install Orca Mobile on Android — Orca Docs

- **URL:** https://www.onorca.dev/docs/android-apk
- **Summary:** Download and install Orca Mobile on Android.
...
1.  Open the [Orca download page](https://www.onorca.dev/download)
     in Chrome or another full browser and select **Android**.
...
2.  Start the [Android download](https://www.onorca.dev/download/started?platform=android)
