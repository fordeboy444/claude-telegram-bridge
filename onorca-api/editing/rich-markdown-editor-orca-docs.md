# Rich markdown editor — Orca Docs

- **URL:** https://www.onorca.dev/docs/editing/markdown
- **Summary:** Rich markdown editor — Orca documentation.
...
![Rich markdown editor — slash menu, inline previews, internal-link autocomplete](https://www.onorca.dev/whats-new/posters/orca-markdown-editor.jpg)
...
\
**Add Review Note** is a remappable shortcut (`Cmd+Shift+A` / `Ctrl+Shift+A` by default under [Settings → Shortcuts](https://www.onorca.dev/docs/settings)\
).\
\
Front matter\
------------\
