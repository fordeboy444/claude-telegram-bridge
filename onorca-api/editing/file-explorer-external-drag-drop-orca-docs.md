# File explorer & external drag-drop — Orca Docs

- **URL:** https://www.onorca.dev/docs/editing/file-explorer
- **Summary:** File explorer & external drag-drop — Orca documentation.
...
*   For [SSH worktrees](https://www.onorca.dev/docs/ssh)
    , drag-drop also works — Orca uploads the file to the remote host before completing the drop, so the agent sees the file as a real on-disk path.
...
*   [Monaco editor & autosave](https://www.onorca.dev/docs/editing/monaco)
     — edit files after you find the match you need.
*   [Diff viewer](https://www.onorca.dev/docs/review/diff-viewer)
     — review the changes your agent or editor made.
