# Quick Open & Jump Palette — Orca Docs

- **URL:** https://www.onorca.dev/docs/model/quick-open
- **Summary:** Cmd-J scoped jump across worktrees, recents, and tabs.
...
Type a web search instead of a path or URL to open it in the worktree browser with your [Default Search Engine](https://www.onorca.dev/docs/settings)
. A single token still ranks file matches first; a multi-word phrase promotes the search row. Prefix the query with `?` to skip file and tab matching and search immediately.
