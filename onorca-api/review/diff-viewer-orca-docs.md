# Diff viewer — Orca Docs

- **URL:** https://www.onorca.dev/docs/review/diff-viewer
- **Summary:** Diff viewer — Orca documentation.
...
*   `c` — start a comment ([Annotate AI Diff](https://www.onorca.dev/docs/review/annotate-ai-diff)
    ).
