# Usage & rate-limit tracking — Orca Docs

- **URL:** https://www.onorca.dev/docs/agents/usage-tracking
- **Summary:** Usage & rate-limit tracking — Orca documentation.
...
Under [Settings → Appearance](https://www.onorca.dev/docs/settings)
, choose **% used** vs **% remaining** for how those numbers read.
...
On the companion app, open the host **Accounts** screen for the same switcher/usage readout. When Codex has earned **rate-limit reset** credits, spend one from that screen (see [Mobile companion](https://www.onorca.dev/docs/mobile)
).
