# Agent session history — Orca Docs

- **URL:** https://www.onorca.dev/docs/agents/session-history
- **Summary:** Browse and resume past Claude, Codex, Cursor, Gemini, and other agent sessions from Orca's right sidebar.
...
*   [Hot-swap Codex accounts](https://www.onorca.dev/docs/agents/codex-hot-swap)
     — switch the Codex login behind an active session without restarting it.
*   [Hooks & memory](https://www.onorca.dev/docs/agents/hooks-memory)
     — control what context an agent picks up on every launch (including resumed sessions).
