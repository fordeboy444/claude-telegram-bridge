# How to use GLM-5.2 in Orca ADE — Orca Docs

- **URL:** https://www.onorca.dev/docs/agents/glm-agent
- **Summary:** Configure Claude Code and other CLI agent harnesses to run GLM-5.2 inside Orca worktrees.
...
Orca supplies the isolated worktree, terminal panes, browser tab, review flow, and session management. Your [Z.ai CodePlan subscription](https://z.ai/subscribe)
 and agent config supply the model access.
