# Browser-use profiles — Orca Docs

- **URL:** https://www.onorca.dev/docs/browser/profiles
- **Summary:** Browser-use profiles — Orca documentation.
...
1.  Open [Settings → Browser → Profiles](https://www.onorca.dev/docs/settings)
    .
